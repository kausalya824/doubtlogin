<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="doubtlogin.Login" %>
        ...
        <div class="container">
            ...
            <form  id="form" runat="server">
                ...
                <div class="input-inform">
                    <asp:TextBox ID="txtUSerID"  runat="server" placeholder="USERNAME..."  autocomplete="off"></asp:TextBox>
               <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" placeholder="PASSWORD..."></asp:TextBox>
                    
               <asp:Button ID="btnSubmit" runat="server" Text="Submit"    OnClientClick="javascript:formdata();" OnClick="btnSubmit_Click" />
...
function formdata() 
{
var firstname1= document.getElementById("txtUSerID").value;
    var lastname1 = document.getElementById("txtPassword").value;
